...
import com.khoerulih.storyapp.databinding.ActivityRegisterBinding
...
class RegisterActivity : AppCompatActivity() {
    ...
    private var isValidName: Boolean? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.let {
            editTextListener(it?.edtName, "name")
    ...
    private fun setButtonEnable() {
        binding?.btnRegister?.let {
            it.isEnabled = isValidName == true && isValidEmail == true && isValidPassword == true
        }
    }
